...
import { NEW_PRODUCT, LIST_PRODUCT, DELETE_PRODUCT } from '../store/types';
...
class ProductListPage extends Component{
    ...
    handleSearch = () => {
        ...
        const action = getAction(LIST_PRODUCT, null, null, query);
        this.props.searchProduct(action);
    ...
    closeDialog = (isConfirmed) => {
        ...
        if (isConfirmed && this.state.productId) {
          const action = getAction(DELETE_PRODUCT, this.state.productId, null, '')
